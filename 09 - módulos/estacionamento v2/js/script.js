...
class EstacionamentoController {
  ...
  lerDados() {
    ...
    let marca = document.getElementById("marcaVeiculo").value
    let ano = document.getElementById("anoVeiculo").value

    let carro = new Carro(nome, ano, marca)
  ...
  calcularResultado() {
    ...
    document.getElementById("maisVelho").innerText = maisVelho.carroToString()
    document.getElementById("maisNovo").innerText = maisNovo.carroToString()
  }
...
export default new EstacionamentoController()
